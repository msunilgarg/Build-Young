...
| **api/funnel.js** | One method-routed endpoint (Hobby 12-function cap): **POST** public event ingest, **GET** founder funnel read (+ `?resource=partners` full records), **PUT** saves cohorts/allowlist/settings/**partners**, **DELETE** resets a test account. Non-POST requires a founder session. |
