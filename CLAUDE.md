...
- **`SEASONS` + `BATCHES` + `CHECKINS`** (all in `src/cohorts.js`, dependency-free) — cohorts run
  in 3 seasonal intakes (Fall 2026, Winter 2027, Spring 2027). ONE combined **"Builders"** track
