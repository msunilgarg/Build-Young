...
const SCREEN_LABELS = { home: "Landing page", story: "Our story (/about)", curriculum: "How it works (/curriculum)", faq: "FAQ (/faq)", enroll: "Enroll flow", "enroll-scholarship": "Scholarship application", call: "Book a call", app: "Student dashboard", login: "Log in", setpw: "Set password", checkemail: "Check your email", founder: "Founder console", verify: "Certificate verify" };
