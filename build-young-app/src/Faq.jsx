...
export const FAQ_ITEMS = [
  ...
  { q: "Why are both paid and scholarship cohorts sometimes open at once?", a: "They run side by side, on purpose. Paid cohorts are always on the schedule. A scholarship cohort only opens when we have sponsorship to cover the seats — and even then, the places are limited and awarded on merit by application, so they aren't guaranteed and not everyone who applies will get one. Keeping a paid cohort open at the same time means there's always a way in: if you apply for a scholarship and aren't selected, you can still enroll in a paid cohort and do the exact same program — the same classes, dashboard, and support." },
