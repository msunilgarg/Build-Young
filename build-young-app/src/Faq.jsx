...
export const FAQ_ITEMS = [
  ...
  { q: "Do you offer scholarships or free seats?", a: "Sometimes — it depends on funding. When we have sponsorship to cover seats, we open a limited number of free scholarship places for that cohort, awarded by application, so it isn't offered every time. When it is, you'll see a free cohort on the enrollment page. If cost is a barrier, tell us who you are and what you'd build — we read every application ourselves, and selected students get the full program, the same classes, dashboard, and support, at no cost." },
