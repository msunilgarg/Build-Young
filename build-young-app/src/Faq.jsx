...
export const FAQ_ITEMS = [
  ...
  { q: "Do you offer scholarships or free seats?", a: "Yes — a limited number of free seats are available by application each cohort. If tuition is a barrier, we want to hear from you: tell us who you are and what you'd build, and we read every application ourselves. Selected students get the full program — the same classes, dashboard, and support — at no cost. When a cohort has free seats open, you apply right from the enrollment page." },
