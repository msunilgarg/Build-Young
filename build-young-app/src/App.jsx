      ...
      <section style={{ position: "relative", overflow: "hidden", background: C.paper2, borderTop: `1px solid ${C.line}`, borderBottom: `1px solid ${C.line}`, marginTop: 30 }}>
        ...
        <div style={{ position: "relative", zIndex: 1, maxWidth: 1000, margin: "0 auto", padding: "56px 6vw 60px" }}>
          ...
          <p style={{ fontSize: 21, lineHeight: 1.5, marginTop: 24, maxWidth: 760, marginLeft: "auto", marginRight: "auto", textAlign: "center", color: C.ink }}>
            <b className="disp">Raising builders, not consumers.</b> Building something people value has always mattered — but AI just collapsed the barrier: what once took a team, a budget, and years of permission, a motivated teenager can now do alone. When anyone can build, the scarce skill flips — not writing the code, but <b>taste</b>: knowing what's worth making, and what <i>good</i> looks like. So the edge isn't a credential. It's taste, and starting early — in <b>founder mode</b>, hands-on and owning the outcome instead of waiting to be ready. We teach it by letting them live it: they build, they earn, then they grow and protect what they've made — because their future rests on what they can make, not what they were credentialed to do.
          </p>
