    ...
    <div style={{ position: "relative", zIndex: 2 }}>
      ...
      <section style={{ position: "relative", overflow: "hidden", background: C.paper2, borderTop: `1px solid ${C.line}`, borderBottom: `1px solid ${C.line}`, marginTop: 30 }}>
        ...
        <div style={{ position: "relative", zIndex: 1, maxWidth: 1000, margin: "0 auto", padding: "56px 6vw 60px" }}>
          ...
          <p style={{ fontSize: 21, lineHeight: 1.5, marginTop: 24, maxWidth: 760, marginLeft: "auto", marginRight: "auto", textAlign: "center", color: C.ink }}>
            <b className="disp">Raising builders, not consumers.</b> Building something people value has always mattered — but AI just collapsed the barrier to entry: what used to take a team, a budget, and years of permission, a motivated teenager can now do alone. When the cost of building falls to almost nothing, the edge isn't talent or a credential — it's starting early, in <b>founder mode</b>: hands-on, in the details, owning the outcome instead of waiting for permission. It's no longer hypothetical — the first <a href="https://every.to/napkin-math/the-one-person-billion-dollar-company" target="_blank" rel="noopener noreferrer" style={{ color: C.emerald, fontWeight: 700, textDecoration: "underline" }}>one-person, billion-dollar company</a>, unthinkable a few years ago, is already arriving. We teach it by letting them live it — they build, they earn, then they learn to grow and protect what they've made — because their future rests on what they can make, not just what they were credentialed to do.
          </p>
      ...
      <section style={{ maxWidth: 1100, margin: "0 auto", padding: "40px 6vw 70px" }}>
        <div style={{ textAlign: "center", maxWidth: 720, margin: "0 auto" }}>
          ...
          <p style={{ color: C.muted, fontSize: 14, marginTop: 8 }}>Not sure it's the right fit? <b>Cancel before your cohort starts for a full refund.</b> After it begins, withdraw through the <b>first week</b> for a prorated refund. After that, tuition is non-refundable.</p>
