    ...
    <div style={{ position: "relative", zIndex: 2 }}>
      ...
      <section style={{ maxWidth: 1100, margin: "0 auto", padding: "40px 6vw 70px" }}>
        <div style={{ textAlign: "center", maxWidth: 720, margin: "0 auto" }}>
          ...
          <p style={{ color: C.ink2, fontSize: 15, marginTop: 8, lineHeight: 1.55 }}>One combined <b>Builders</b> cohort for ages <b>13–18</b>, meeting <b>twice a week</b> (~3 hrs) — choose <b>Mondays & Wednesdays</b> or <b>Tuesdays & Thursdays</b> — <b>100% live online over Zoom</b>. Two cohorts each season; pick the days that fit.</p>
