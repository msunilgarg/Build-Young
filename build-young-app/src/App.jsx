          ...
          <Card style={{ padding: 28, marginTop: 34, display: "flex", gap: 20, alignItems: "flex-start", flexWrap: "wrap" }}>
            ...
            <div style={{ flex: 1, minWidth: 260 }}>
              ...
              <p style={{ color: C.ink2, fontSize: 16, lineHeight: 1.6, marginTop: 8 }}>
                I build AI products for a living, and up close you can see how fast the ground is moving: what used to take a team and a budget, a motivated teenager can now do alone, with AI. The edge isn't a credential anymore — it's what you can build, and the taste to know what's worth making. That's the shift I can't stop thinking about, because I got here the slow way: I came to the United States with almost nothing and built a life from zero, two decades of it as a product leader at Microsoft. I'd have gotten there years sooner if I'd started building early — and I want my own kids on the right side of this shift, not the wrong one. I have two daughters, 15 and 11 — both at Eastside Catholic School in Sammamish, and both with a Starbucks habit I'm gently working on. My wife teaches at Issaquah Montessori School, so between the two of us this house takes how kids learn seriously. I want them building while the advantage is still theirs to take.
              </p>
              <p style={{ color: C.ink2, fontSize: 16, lineHeight: 1.6, marginTop: 12 }}>
                So I went looking for a class that taught it: how to make something real with AI, put it in front of people, and then handle the money it earns. There's plenty of free material out there; banks and nonprofits have whole libraries of it. But it sits unwatched, because a video doesn't make a teenager show up. The paid classes that are live mostly teach stock-picking — the flashy 10%, not the part that actually shapes a life. And not one of them teaches building. So I made one.
              </p>
              <p style={{ color: C.ink2, fontSize: 16, lineHeight: 1.6, marginTop: 12 }}>
                It's the thing I couldn't find: a live class, a small group, a standing weekly time — what turns “available” into “actually done.” It starts where almost none do — actually <b>building something of your own</b> with AI, that people would pay for — then turns to what comes next: growing it into a business, and managing the money it earns. One continuous twelve-week simulation where the decisions compound and the mistakes are safe, because the money isn't real yet.
              </p>
              <p style={{ color: C.ink2, fontSize: 16, lineHeight: 1.6, marginTop: 12 }}>
                That's the whole idea: building is a skill you practice, not a subject you study — and so is the money that follows. We're raising builders, not consumers — kids who reach adulthood having already lived it. I called it Build Young because the one advantage they have that no one can buy is time, and it compounds — habits, character, taste, and even a few invested dollars all grow with it.
              </p>
              <p style={{ color: C.ink2, fontSize: 16, lineHeight: 1.6, marginTop: 12 }}>
