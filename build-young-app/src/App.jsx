          ...
          <Card style={{ padding: 28, marginTop: 34, display: "flex", gap: 20, alignItems: "flex-start", flexWrap: "wrap" }}>
            ...
            <div style={{ flex: 1, minWidth: 260 }}>
              ...
              <p style={{ color: C.ink2, fontSize: 16, lineHeight: 1.6, marginTop: 8 }}>
                I came to the United States with almost nothing — and with family back home depending on me to provide. My wife and I built our lives from zero, supporting them while finding our footing, and made this our own country. Two decades as a product leader at Microsoft later, I'd reached financial independence and was able to step away at 51. But here's the truth I can't stop thinking about: if I'd understood how money works — and how to build something of my own — when I was a teenager, I'd have gotten there years sooner. That lost time is the whole reason this exists. I have two daughters, 15 and 11 — both at Eastside Catholic School in Sammamish, and both with a Starbucks habit I'm gently working on. I wanted them to learn this before the world started making those decisions for them.
              </p>
              <p style={{ color: C.ink2, fontSize: 16, lineHeight: 1.6, marginTop: 12 }}>
                These days I build AI products for a living, and here's what I keep seeing: AI just collapsed the barrier to building. A motivated teenager can now make a real product alone — the kind of thing that used to take a whole team and a budget. When AI does the heavy lifting, the edge isn't a credential; it's <b>taste</b> — knowing what's worth making and having the judgment to make it good. The kids who learn to <b>build</b>, not just consume, will own their futures. That's the skill I wanted my daughters to have — and the one almost no class teaches.
              </p>
              <p style={{ color: C.ink2, fontSize: 16, lineHeight: 1.6, marginTop: 12 }}>
                So I went looking for a class that taught both — how to build something real, and how to handle the money it earns. There's plenty of free material out there; banks and nonprofits have whole libraries of it. But it sits unwatched, because a video doesn't make a teenager show up. The paid classes that are live mostly teach stock-picking — the flashy 10%, not the part that actually shapes a life. And not one of them teaches building. So I made one.
              </p>
              <p style={{ color: C.ink2, fontSize: 16, lineHeight: 1.6, marginTop: 12 }}>
              ...
              <div>
                ...
                {b.full ? (
                  ...
                  <div style={{ marginTop: 12, fontSize: 12, color: C.muted, lineHeight: 1.5, background: C.paper, borderRadius: 6, padding: "9px 12px" }}>
                    <b style={{ color: C.ink2 }}>A note on costs:</b> tuition is the only required cost. To build, students use mostly free tools; one — an AI assistant — has an <b>optional ~$20/month</b> upgrade we recommend (a free tier works too). Later, a custom web address (domain) is <b>optional</b> and runs about <b>$10–20/year</b> if you want one. Nothing else is required.
                  </div>
