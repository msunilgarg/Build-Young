    ...
    <div style={{ position: "relative", zIndex: 2 }}>
      ...
      <header style={{ position: "relative", overflow: "hidden", padding: "40px 6vw 64px" }}>
        ...
        <p className="rise" style={{ maxWidth: 620, margin: "26px auto 0", fontSize: 19, color: C.ink2, lineHeight: 1.5 }}>
          Build Young is a <b>live, instructor-led course</b> where teens learn to <b>build economic value</b> — for themselves, by creating something worth paying for. Money, assets, and a product of their own are all just ways to do that: the deeper lesson is that you get ahead by adding value to other people's lives. They run a realistic simulation — earning a paycheck, growing it through real-world market swings, financing a home and a car, and launching something people would actually pay for — and graduate having built a net worth from zero. <b>Financial literacy is the foundation; building value is the point.</b> It's a hands-on sandbox — <b>no real money is ever involved</b> — just the real skills, practiced somewhere safe before the stakes are real.
        </p>
        <HeroPreview />
