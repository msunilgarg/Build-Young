        ...
        <div style={{ position: "relative", zIndex: 1, maxWidth: 1000, margin: "0 auto", padding: "40px 6vw 44px" }}>
          ...
          <Card style={{ padding: 28, marginTop: 34, display: "flex", gap: 20, alignItems: "flex-start", flexWrap: "wrap" }}>
            ...
            <div style={{ flex: 1, minWidth: 260 }}>
              ...
              <p style={{ color: C.ink2, fontSize: 16, lineHeight: 1.6, marginTop: 12 }}>
                We went looking for a class that actually taught that — building something real with AI and putting it in front of people — and couldn't find the right one. What's out there is either a pricey summer intensive, a coding class that stops the moment something is built, or free material that's easy to start and easy to abandon — and a video never made a teenager show up. So we made the one we wanted for our own kids: affordable, live, a small group on a standing weekly time — what turns “available” into “actually done.”
              </p>
              <p style={{ color: C.ink2, fontSize: 16, lineHeight: 1.6, marginTop: 12 }}>
