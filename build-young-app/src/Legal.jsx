...
export const LEGAL = {
  ...
  terms: {
    ...
    sections: [
      ...
      ["Refund policy", "Cancel any time before your cohort's first session for a full refund. Once the program has started, you may withdraw for a flat 75% refund through the end of the first week. After the first week, tuition is non-refundable."],
