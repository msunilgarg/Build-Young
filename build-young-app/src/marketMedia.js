...
export const WEEK_PREP = [
  ...
  "Make sure your Claude account + tools are ready, and your 4-prompt spec is written. We build Prompt 1 — the core product — together, live.",
  "Have your core product working. This week we add Prompt 2: sign-in and saving each user's data — so come knowing who logs in and what should be saved for them.",
  "Your product works and remembers users — this week we add Prompt 3: real payments. Come knowing what people pay for and what they get.",
  "It works and can take payment — this week is Prompt 4: make it real (emails, being findable, keeping data safe). Note anything that still feels rough.",
