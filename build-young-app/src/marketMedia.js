...
export const WEEK_PREP = [
  ...
  "Your product is real but still has rough edges — this lesson you finish and harden it: tidy the loose ends, test the tricky paths, and make it solid. Come with a short list of what still feels unfinished.",
...
export const WEEK_OBJECTIVES = [
  ...
  "It works and can take payment. This lesson you spec and add the unglamorous layer that makes it trustworthy — emails, being findable, keeping data safe; next lesson you finish and harden it.\nWhat separates a class project from something a customer can rely on: emails, being findable, keeping data safe.\nThe finishing work is invisible when it's done right — and obvious when it's missing.\nSweating these details is taste, too — people feel the polish even when they can't name it.\n\"Production-ready\" is a mindset: assume real people, real mistakes, real stakes.",
  "Your product is real but rough in places. This lesson you finish and harden it — so next lesson you can take it live with confidence.\nReal builders spend real time on the last 10% — the rough edges are exactly what users feel first.\nHardening means testing the tricky paths: empty states, wrong input, the thing that breaks when two people use it at once.\nFinishing is a discipline — \"mostly done\" isn't done; you make it solid before you ship.\nKnowing when it's solid enough to launch is its own kind of taste.",
