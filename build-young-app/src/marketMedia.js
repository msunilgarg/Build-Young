...
export const WEEK_PREP = [
  ...
  "Jot what 'active' means for your product (a daily user? a weekly one?). This week we add metrics — active users, retention, and where people drop off — to see how it's really doing.",
  "Think about how a stranger first finds and tries your product. This week we build a funnel — find → try → come back — to fix where people were falling away.",
