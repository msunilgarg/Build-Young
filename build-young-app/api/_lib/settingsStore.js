...
// notifyEmail = where founder alerts go. scenarioAgentEnabled/scenarioModel = the Week-9 funnel agent (the
// only student-facing AI agent left; the review + kit-polish agents were removed in SPECS/014). The API
